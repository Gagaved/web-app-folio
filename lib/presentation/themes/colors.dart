...
class AppColors {
  ...
  static const Color backgroundColor = Color(0xFFE7E5E8);
  static const Color onBackgroundColor = Color(0xFF000000);
  static const Color surfaceColor = Color(0xFFFCF9FF);
  static const Color onSurfaceColor = Color(0xFF4B3C5D);

  ///colors for dark theme
  static const Color darkPrimaryColor = Color(0xFFF5D4FF);
  static const Color onDarkPrimaryColor = Color(0xFFFFFFFF);
  static const Color darkSecondaryColor = Color(0xFF200033);
  static const Color onDarkSecondaryColor = Color(0xFF57F100);
  static const Color darkErrorColor = Color(0xFFEE3333);
  static const Color onDarkErrorColor = Color(0xFFFFFFFF);
  static const Color darkBackgroundColor = Color.fromARGB(255, 22, 21, 31);
  static const Color onDarkBackgroundColor = Color(0xFFC791FF);
